        ...
        <div className="consent" style={{ display: consent ? 'hidden' : 'block' }}>
            <div className="consent-container">
                ...
                <div className="consent-container-buttons">
                    ...
                    <button className="consent-container-buttons-deny" onClick={() => denyCookie()}>
                        Refuser
                    </button>
                    <button
                        onClick={() => {
                        ...
                        className="consent-container-buttons-accept"
                    >
                        Accepter
                    </button>
                </div>
